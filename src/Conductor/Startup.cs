    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            if (string.IsNullOrEmpty(redisConnectionStr))
                ...
                services.AddSingleton<IClusterBackplane>(sp => new RedisBackplane(redisConnectionStr, "conductor",
                    sp.GetService<IDefinitionRepository>(), sp.GetService<IWorkflowLoader>(),
